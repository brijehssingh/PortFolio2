        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[auto,1fr] gap-10 items-center">
            ...
            <div className="avatar place-self-center lg:place-self-start">
              <div className="w-44 rounded-2xl ring ring-primary ring-offset-base-100 ring-offset-2 shadow-xl hover:scale-105 transition-transform duration-300">
                <img
          ...
          {/* soft separator wave */}
          <svg className="w-full mt-12 opacity-20" height="24" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0V46.29c47.79,22,103.59,29.86,158,24,70.36-7.61,136-31.93,206-35.52,102.17-5.4,198.12,31.3,300,38.06,98.35,6.51,191.06-18.06,288-31.91,86.39-12.28,175.12-8.33,248,6.85V0Z" className="fill-base-200"></path>
          </svg>
        </div>
      </section>
